...
\midrule
\texttt{203.0.113.89} & 1 & 87 & $\approx$29$\times$ the established baseline; no prior accepted login from this source \\
Twelve established sources & 389 & 3 & Defines the established baseline ($\leq$3 preceding-hour failures) \\
\bottomrule
\end{tabularx}
\end{table}
